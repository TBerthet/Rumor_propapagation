...
Sx = 50 + 0.1*(-1 + 2*rand(J,1)); 
Ix = 5 + 0.1*(-1 + 2*rand(J,1));
...
for tt=1:Nt
    ...
    % chemin_complet = fullfile('C:\Users\berth\OneDrive\Bureau\4bim\S1\biomaths4\projetbm4\rumor_propagation\picture\allee\a_10', nom_fichier);
